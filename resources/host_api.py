...
from .hosts import HostView, HostUserView, AvailableHost
...
host_api = Api(bp_host_api)
host_api.add_resource(HostView, '/hosts')
host_api.add_resource(AvailableHost, '/available_hosts')
host_api.add_resource(HostUserView, '/host_users')
