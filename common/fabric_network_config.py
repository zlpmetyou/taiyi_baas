...
from common import CONSENSUS_PLUGINS_FABRIC_V1, CONSENSUS_MODES, \
    NETWORK_TYPE_FABRIC_PRE_V1, NETWORK_TYPE_FABRIC_V1_1, \
...
class FabricV1NetworkConfig(BlockchainNetworkConfig):
    ...
    def __init__(self, consensus_plugin='solo', orderer=1, ca=1, peer=2, org=1, **kwargs):
        """
        Init.
        ...
        """
        self.network_type = NETWORK_TYPE_FABRIC_V1_1
        self.consensus_plugin = consensus_plugin
    ...
    def validate(self):
        ...
        return self.consensus_plugin in CONSENSUS_PLUGINS_FABRIC_V1
...
class FabricNetworkConfig(BlockchainNetworkConfig):
    ...
    def __init__(self, network_type, channel, orderer_org, peer_orgs, consensus_plugin='solo', **kwargs):
        """
        Init.
        ...
        super(FabricNetworkConfig, self).__init__()
